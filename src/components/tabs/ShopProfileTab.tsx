            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-zinc-50 border-2 border-black p-5 pl-14 font-['Space_Grotesk'] font-bold text-lg text-black focus:outline-none focus:bg-white focus:shadow-[4px_4px_0px_0px_#7D12FF] transition-all"
                />
              </div>
            </div>
